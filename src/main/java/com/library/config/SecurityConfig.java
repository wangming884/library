    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/api/book/search", "/api/book/*", "/api/book/*/available-copies", "/api/book/*/reviews", "/api/announcements/**", "/api/book/rank", "/api/book/new", "/api/categories", "/api/seat/available", "/api/reader-types").permitAll()
